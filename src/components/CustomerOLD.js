...
class Customer extends Component {
    ...
    fetchCustomers = async () => {
        try {
            const { page, customers } = this.state;
            const newCustomers = await customerService.getCustomers(page);
            this.setState(prevState => ({
                customers: [...prevState.customers, ...newCustomers],
                page: prevState.page + 1,
                hasMore: newCustomers.length > 0
            }));
        } catch (error) {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            this.fetchCustomers();
            this.setState({ formData: { /* Campos do formulário */ } });
        } catch (error) {
    ...
    render() {
        ...
        const { formData, notification, customers, hasMore } = this.state;
        return (
                ...
                <div className="customer-grid">
                    <div className="grid-header">
                        <FaPlus 
                            ...
                            onClick={() => this.setState({ formData: { /* inicialize o formulário */ } })}
                    ...
                    <InfiniteScroll
                        ...
                        endMessage={<p>No more customers to load.</p>}
                    >
                        <table>
                            <thead>
                                <tr>
